			...
			<table class="table">
				...
				<tbody>
					<tr th:each="product : ${products}">
						<th scope="row"><img alt="" th:src="*{'data:image/jpg;base64,'+{product.touchandlcdImage}}" style="width: 100px;height: 100px;"></th>
						<td>[[*{product.brand}]] 
						...
						<td>[[*{product.brandseries}]] <!-- Button trigger modal -->
							<br>
							<button type="button" class="btn btn-success btn-sm mt-2"
								data-toggle="modal"
						...
						<td>[[*{product.audiojack}]] <!-- Button trigger modal --> <br>
							<button type="button" class="btn btn-success btn-sm mt-2"
								data-toggle="modal"
