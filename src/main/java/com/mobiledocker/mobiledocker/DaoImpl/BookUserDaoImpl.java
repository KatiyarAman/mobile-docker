...
public class BookUserDaoImpl extends GenricRepositroyImpl<BookUser> implements BookUserDao, InitializingBean {
    ...
    public List<BookUser> findBySortedCustomerId() {
        ...
        /*
         * Session session=getCurrentSession(); Transaction txn=null; try
         * {txn=session.beginTransaction();
         * bookUserList=session.createQuery("from book_user").list();
         */
        return super.list();

        /*
         * txn.commit(); } catch (Exception e) { // TODO: handle exception bookUserList
         * = null; if(txn !=null) { txn.rollback(); } }finally { session.close(); }
         * return bookUserList
         */
    }
