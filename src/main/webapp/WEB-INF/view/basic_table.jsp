...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="${contextPath}/t" class="logo">Nice <span class="lite">Admin</span></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="active" href="${contextPath}/t">Basic Table</a></li>
            </ul>
          </li>
                  ...
                  <c:forEach var="user" items="${users}">
                    <tr>
                      ...
                      <div class="d-grid gap-2 d-md-block">
                        ...
                        <a class="btn btn-danger"  href="#deleteModal"  data-toggle="modal" ><i class="icon_close_alt2" data-toggle="tooltip"></i></a>
                         <input type="hidden" id="warehouseId" value="${user.warehouseId}">
                      </div>
                      </td>
                    </tr>
                 ...
                 <div class="form-group">
                    <div class="col-lg-10">
                      <div class="row">
                        ...
                        <span class="input-group-text"STYLE="text-transform:capitalize">brandName</span> 
                          <input type="text" id="brandName"  readOnly="readOnly"  class="form-control" aria-describedby="passwordHelpInline" >						
                        </div>
                        <div class="col-lg-3">
                  ...
                  <div class="form-group">
                    <div class="col-lg-10">
                      <div class="row">
                        <div class="col-lg-3">
                        <span class="input-group-text"STYLE="text-transform:capitalize">touchScreenGlass</span>
                          <input type="text"   id="touchscreenglass" name="" class="form-control"placeholder="touchscreenglass">
                        </div>
                        <div class="col-lg-3">
                        <span class="input-group-text" STYLE="text-transform:capitalize">standbyphone</span>
                        <input type="text"  id="standbyphone"  name=""class="form-control"placeholder="standbyphone">
                    ...
                    <div class="col-lg-10">
                      <div class="row">
                        ...
                        <span class="input-group-text" STYLE="text-transform:capitalize">chargeport</span>
                          <input type="text"  id="chargeport" name="" class="form-control"placeholder="chargeport">
                        </div>
                        <div class="col-lg-3">
                        <span class="input-group-text" STYLE="text-transform:capitalize">loudspeaker</span>
                          <input type="text"   id="loudspeaker" name="" class="form-control"placeholder="loudspeaker">
                        </div>
                        <div class="col-lg-3">
                        <span class="input-group-text" STYLE="text-transform:capitalize">earspeaker</span>
                          <input type="text"  id="earspeaker" name=""  class="form-control"placeholder="earspeaker">
                        </div>
                      </div>                      
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-10">
                      <div class="row">
                       ...
                       <input type="text"  id="audiojack" name="" class="form-control"placeholder="audiojack">
                        </div>
                        <div class="col-lg-3">
                        <span class="input-group-text" STYLE="text-transform:capitalize">microphone</span>
                          <input type="text"  id="microphone" name="" class="form-control"placeholder="microphone">
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="col-lg-10">
                      <div class="row">
                        ...
                        <span class="input-group-text" STYLE="text-transform:capitalize">s/wdiagnosis</span>
                          <input type="text"   id="softwarediagnosis" name="" class="form-control"placeholder="softwarediagnosis">
                        </div>
                        <div class="col-lg-3">
                        <span class="input-group-text" STYLE="text-transform:capitalize">dead/pdiagnosis</span>
                         <input type="text" id="deadphonediagnosis" name="" class="form-control"placeholder="deadphonediagnosis">
                        </div>
                        <div class="col-lg-3">
                        <span class="input-group-text" STYLE="text-transform:capitalize">waterdiagnosis</span>
                          <input type="text"  id="waterdiagnosis" name="" class="form-control"placeholder="waterdiagnosis">
                        </div>
                      </div>
