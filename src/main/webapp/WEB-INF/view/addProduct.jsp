        ...
        <div class="card-body">
            <form action="${contextPath}/addP" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" name="touchandlcd" id="touchandlcd" class="form-control mb-4"
                ...
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="touchscreenglass" id="touchscreenglass" class="form-control mb-4"
                           placeholder="touchscreenglass">
                    <div class="custom-file mb-2">
                        <input type="file" class="custom-file-input" name="touchscreenglassImage"
                               id="touchscreenglassImage">
                ...
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="chargeport" id="chargeport" class="form-control mb-4"
                ...
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="loudspeaker" id="loudspeaker" class="form-control mb-4"
                ...
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="earspeaker" id="earspeaker" class="form-control mb-4"
                ...
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="audiojack" id="audiojack" class="form-control mb-4"
                ...
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="microphone" id="microphone" class="form-control mb-4"
                ...
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="softwarediagnosis" id="softwarediagnosis" class="form-control mb-4"
                           placeholder="softwarediagnosis">
                    <div class="custom-file mb-2">
                        <input type="file" class="custom-file-input" name="softwarediagnosisImage"
                               id="softwarediagnosisImage">
                        <label class="custom-file-label" for="customFile">softwarediagnosis Image</label>
                    </div>
                </div>
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="deadphonediagnosis" id="deadphonediagnosis" class="form-control mb-4"
                           placeholder="deadphonediagnosis">
                    <div class="custom-file mb-2">
                        <input type="file" class="custom-file-input" name="deadphonediagnosisImage"
                               id="deadphonediagnosisImage">
                        <label class="custom-file-label" for="customFile">deadphonediagnosis Image</label>
                    </div>
                </div>
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="waterdiagnosis" id="waterdiagnosis" class="form-control mb-4"
                           placeholder="waterdiagnosis">
                    <div class="custom-file mb-2">
                        <input type="file" class="custom-file-input" name="waterdiagnosisImage"
                               id="waterdiagnosisImage">
                        <label class="custom-file-label" for="customFile">waterdiagnosis Image</label>
                    </div>
                </div>
                <!-- Name -->
                <div class="form-group">
                    <input type="text" name="standbyphone" id="standbyphone" class="form-control mb-4"
                ...
                <div class="form-group">
                    ...
                    <!-- Name -->
                    <input type="text" name="modelseries" id="modelseries" class="form-control mb-4"
                           placeholder="modelseries">
                </div>
                <!-- Sign in button -->
