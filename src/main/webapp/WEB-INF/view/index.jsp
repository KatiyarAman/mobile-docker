        ...
        <form id="msform" >
           ...
           <div class="alert alert-danger" role="alert">
            ...
            <fieldset>
                ...
                <div class="row">
                   <div class="col">
                <input type="text" name="fname" value="${formData.fname}"id="fname" placeholder="First Name" required/>
                </div>
                <div class="col">
                <input type="text" name="lname" placeholder="Last Name"/>
                </div>
                </div>
                <input type="text" name="phone"id="phone" value="${formData.mobilenumber}" placeholder="Phone no" required/>
                <div class="row">
                   <div class="col">
                   <input type="text" name="cityname"id="cityname" value="${formData.cityname}" placeholder="City" required/>
                    </div>
                    <div class="col">
                   <input type="text" name="zipcode"id="zipcode" value="${formData.zipcode}" placeholder="ZipCode" required/>
                   </div>
                   </div>
            ...
            <fieldset>
                ...
                <input type="text" name="brand" id="brand" value="${formData.selectbrands}"placeholder="Brand" required/>
                <input type="text" name="model" id="model" value="${formData.selectmodel}"placeholder="Model" required/>
                <input type="button" name="next" class="next action-button" value="Next"/>
            ...
            <fieldset>
                ...
                <input type="text" name="issue" id="issue" placeholder="description" value="${formData.descrip}"required/>
                <input type="text" name="reason" id="reason"value="${formData.reason}"placeholder="Reason"/>
                <input type="button" name="submit"  onClick="myFunction()"class="submit action-button" value="Submit"/>
            </fieldset>
        </form>
                    ...
                    <div class="modal-content">
                      ...
                      <form role="form">
                          <div class="form-group">
                            ...
                            <input type="text" style="width:190px" class="form-control" id="idCustomerId"  placeholder="Enter CustomerId">
                          </div>                                              
